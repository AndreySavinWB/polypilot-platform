...
| 4d | **Whale Check (Hashdive)** | Крупные игроки 5.7 | normalized + MI + odds | `whaleCheck` | ⚠️ mock | MVP |
| 5 | **Contradiction Engine** | Почему рынок wrong | MI + evidence + crowd + PMA + whales + market | contradiction map | ⬜ | V1.3 |
